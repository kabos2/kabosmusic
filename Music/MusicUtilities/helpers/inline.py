...
def play_markup(videoid, user_id):
    buttons = [
        ...
        [      
               InlineKeyboardButton(text="اخفاء💕", callback_data=f"close"),
        ],
    ]
    return buttons
...
def others_markup(videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="تحميل الاغنيه♥", callback_data=f"gets audio|{videoid}|{user_id}"
            ),
            InlineKeyboardButton(
        ...
        [
            InlineKeyboardButton(
                text="عوده🥀", callback_data=f"goback {videoid}|{user_id}"
            ),
            InlineKeyboardButton(text="اخفاء💕", callback_data=f"close2"),
        ],
    ]
    return buttons
...
play_keyboard = InlineKeyboardMarkup(
    [
        ...
        [InlineKeyboardButton("اخفاء💕", callback_data="close")],
    ]
)
...
def audio_markup(videoid, user_id):
    buttons = [
        ...
        [InlineKeyboardButton(text="اخفاء💕", callback_data="close2")],
    ]
    return buttons
...
def search_markup(
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="💕 - اضغط لأظهار قائمة بحث الأغاني الثانيه - 💕", callback_data=f"popat 1|{query}|{user_id}")],
        [
            InlineKeyboardButton(
                text="اخفاء💕", callback_data=f"ppcl2 smex|{user_id}"
            ),
        ],
    ]
    return buttons
...
def search_markup2(
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="اخفاء💕", callback_data=f"ppcl2 smex|{user_id}")],
    ]
    return buttons
...
start_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "الاوامـــر التشغيل هنا : 📚", url="https://t.me/WD_RG/5"
            )
        ],
        [InlineKeyboardButton("اخفاء💕", callback_data="close2")],
    ]
)
...
confirm_group_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("اضغط هنا وشاهد 🥀", callback_data="cbgroupdel"),
            InlineKeyboardButton("اخفاء💕", callback_data="close2"),
        ]
    ]
)
